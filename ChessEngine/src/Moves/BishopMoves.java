...
public class BishopMoves {
    ...
    public static long PCTBishopMoves(byte square, long occupied_squares){
        ...
        //diagonal
        long possibilities_diagonal_up=(occupied_squares&Diagonal_Masks[diagonal_index]) - (2 * bishop);
        long possibilities_diagonal_down=Long.reverse(Long.reverse(occupied_squares&Diagonal_Masks[diagonal_index]) - (2 * Long.reverse(bishop)));
        ...
        //anti_diagonal
        long possibilities_anti_diagonal_up=(occupied_squares&Anti_Diagonal_Masks[anti_diagonal_index]) - (2 * bishop);
        long possibilities_anti_diagonal_down=Long.reverse(Long.reverse(occupied_squares&Anti_Diagonal_Masks[anti_diagonal_index]) - (2 * Long.reverse(bishop)));
